...
function main()
	frame = wx.wxFrame(wx.NULL, wx.wxID_ANY, "Source server browser", wx.wxDefaultPosition, wx.wxSize(600, 400), wx.wxDEFAULT_FRAME_STYLE)
	listCtrl = wx.wxListView(frame, ID_LISTCTRL, wx.wxDefaultPosition, wx.wxDefaultSize, wx.wxLC_REPORT + wx.wxLC_SINGLE_SEL + wx.wxLC_HRULES + wx.wxLC_VRULES)
...
local function server_reply(what, entry, x)
	if what == nil then end --Msg"[Server Info] Fail "print(entry,x)
